...
fetch('/terminarz2').then( (res) => {
    ...
    if(data[0] !== ""){
        const teams = data[0].teams.length;
        ...
        while(l6<=teams){
            ...
            while(l7<=teams){
                ...
                if(!l6&&l7){
                    td[l7].innerText = data[0].teams[l7-1];
                }
                if(l6&&!l7){
                    td[l7].innerText = data[0].teams[l6-1];
                }
                if(l6&&l7&&l6!==l7){
    ...
    if(data[1] !== ""){
        for(let l8 = 1; l8<=data[0].teams.length; l8++){
            for(let l9 = 1; l9<=data[0].teams.length; l9++){
                if(l8!==l9){
